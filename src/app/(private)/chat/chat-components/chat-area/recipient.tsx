...
import { clearSelectedChat } from '@/redux/chatSlice'
import { useDispatch } from 'react-redux'



export default function Recipient({ isMobile }: { isMobile: boolean }) {
    ...
    return (
        <div className='flex justify-between items-center px-5 py-3 border-b border-gray-200 bg-gray-300 w-full cursor-pointer'>
            ...
            <div className='flex items-center gap-4'>
                ...
                <div className='flex gap-3 items-center' onClick={() => setShowRecipientInfo(true)}>
                    <img
